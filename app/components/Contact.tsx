...
import { Mail, Github, Send, FileText } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 gap-6 rounded-2xl border border-white/10 bg-navy-900 p-5 sm:p-7 lg:grid-cols-2 lg:gap-10">
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="group flex min-h-[48px] items-center gap-3 rounded-xl border border-white/10 bg-navy-800 px-4 py-3 text-sm text-slate-300 transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/50 hover:bg-navy-700 hover:text-white"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex min-h-[48px] items-center gap-3 rounded-xl border border-accent/30 bg-accent/10 px-4 py-3 text-sm font-medium text-accent-soft transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/60 hover:text-white"
              >
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="group inline-flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-accent px-5 text-sm font-semibold text-navy-950 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-accent/30"
              >
